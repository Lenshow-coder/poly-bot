...
| 9 | `core/polymarket_client.py` | REST client: CLOB auth, Gamma event fetch, order book (ask sort fix), prices, USDC balance, order placement, contract approvals, positions. RPC fallback across multiple endpoints. |
...
- **Step 4:** USDC balance matches your wallet. Confirms native USDC address (`0x3c499...`) is correct.
...
| USDC balance reads correctly from chain | Step 4 | Yes |
